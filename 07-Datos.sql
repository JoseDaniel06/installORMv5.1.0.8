...
Insert into OPT_CONFIGURATION(PARAMETER, DESCRIPTION, VALUE)
Values('USE_ORM_CONNECTION_FOR_LOV', 'Determina si las listas de valores de los parámetros se cargan con la misma conexión de ORM (S) o si se cargan con la conexión de la consulta base (N)', 'N');
